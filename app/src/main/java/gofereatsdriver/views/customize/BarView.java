...
public class BarView extends View {
    ...
    private final int FOREGROUND_COLOR = Color.parseColor("#ff65B963");
    ...
    public BarView(Context context, AttributeSet attrs) {
       ...
       /* bgPaint = new Paint();
        ...
        rect = new Rect();
        topMargin = ImageUtils.dip2px(context, 5);
        int textSize = ImageUtils.sp2px(context, 15);
        barWidth = ImageUtils.dip2px(context, 22);
        MINI_BAR_WIDTH = ImageUtils.dip2px(context, 22);
        BAR_SIDE_MARGIN = ImageUtils.dip2px(context, 18);
        TEXT_TOP_MARGIN = ImageUtils.dip2px(context, 5);
        textPaint = new Paint();
...
*/
                rect.set(BAR_SIDE_MARGIN * i + barWidth * (i - 1), topMargin + (int) ((getHeight() - topMargin - bottomTextHeight - TEXT_TOP_MARGIN) * percentList.get(i - 1)), (BAR_SIDE_MARGIN + barWidth) * i, getHeight() - bottomTextHeight - TEXT_TOP_MARGIN);
        ...
        if (bottomTextList != null && !bottomTextList.isEmpty()) {
            i = 1;
            for (String s : bottomTextList) {
                canvas.drawText(s, BAR_SIDE_MARGIN * i + barWidth * (i - 1) + barWidth / 2, getHeight() - bottomTextDescent, textPaint);
                i++;
            }
        }
    }
